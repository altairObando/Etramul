...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Cootracosan","1. Inicio de sesión","2. Menu General","2.1. Usuario","2.2. Socios","2.3. Carrera","2.4. Conductor","2.5. Vehiculo","2.6. Transacciones","2.7. Cambiar Usuario","2.8. Herramientas","2.9. Salir"],
    DREX_NODE_LINKS: ["index.htm","inicio_de_sesion.htm","menu_general__.htm","usuario.htm","socios.htm","carrera.htm","conductor.htm","vehiculo.htm","transacciones.htm","cambiar_usuario.htm","herramientas.htm","salir.htm"],
    DREX_NODE_CHILD_START: [1,3,3,12,12,12,12,12,12,12,12,12],
    DREX_NODE_CHILD_END: [3,3,12,12,12,12,12,12,12,12,12,12],
    DREX_MENU_TYPE: 2,
